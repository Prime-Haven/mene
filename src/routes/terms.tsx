...
const sections: Array<{ title: string; body: string[] }> = [
  ...
  },
  {
    ...
    body: [
      "Mene:Log offers tiered monthly packages billed in United States Dollars (USD) or local currency equivalents: Basic ($15/month), Standard ($30/month), and Premium ($55/month).",
