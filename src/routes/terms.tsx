  ...
  head: () => ({
    meta: [
      { title: "Terms of Use — Mene" },
      {
        name: "description",
        content:
          "Comprehensive terms governing church accounts, subscriptions, onboarding, member check-in records, leadership permissions, and data protection on Mene.",
      },
      { property: "og:title", content: "Terms of Use — Mene" },
      { property: "og:description", content: "Comprehensive accounts, subscriptions, acceptable use and data protection terms for Mene." },
...
const sections: Array<{ title: string; body: string[] }> = [
  {
    ...
    body: [
      ...
      "These Terms also govern the use of Mene by invited church staff, ushers, group leaders, and attendees accessing public self-check-in portals under your church's designated address.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      "All membership records, attendance logs, demographics, contact details, notes, and messages entered into Mene are the sole and exclusive intellectual property of the respective Church.",
  ...
  },
  {
    ...
    body: [
      "Mene enforces strict role-based access control (RBAC): Administrators retain full configuration and reporting access; Ushers are restricted to scanning QR codes and taking door attendance; Leaders are granted access strictly to their assigned group members.",
  ...
  },
  {
    ...
    body: [
      ...
      "Mene's automated messaging engine (SMS and email broadcasts) must only be used to communicate authentic ministry announcements, devotional content, service reminders, and pastoral follow-ups. Sending spam, deceptive communications, or unconsented solicitations is strictly prohibited.",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-5 py-16">
        ...
        <p className="mt-3 text-base leading-relaxed text-muted-foreground">
          Comprehensive operational, subscription, data stewardship, and acceptable use terms governing churches and leadership accounts on Mene.
        </p>
